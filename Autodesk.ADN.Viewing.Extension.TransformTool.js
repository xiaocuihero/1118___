    ...
    function TransformTool() {
        ...
        function onAggregateSelectionChanged(event) {
            ...
            if(event.selections && event.selections.length) {
                ...
                // var fragProxy = viewer.impl.getFragmentProxy(model, fragIdsArray[0]);  
                ...
                OnSelectedChanged(event.selections);

                // translateUpdate(event.selections);

                // console.log(event.selections);

                // OnSelectedChanged0(event.selections);
